...
RSpec.describe BorrowsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all borrows as @borrows" do
      borrow = Borrow.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:borrows)).to eq([borrow])
    end
  end

  describe "GET #show" do
    it "assigns the requested borrow as @borrow" do
      borrow = Borrow.create! valid_attributes
  ...
  describe "GET #new" do
    it "assigns a new borrow as @borrow" do
      get :new, params: {}, session: valid_session
      expect(assigns(:borrow)).to be_a_new(Borrow)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created borrow as @borrow" do
        post :create, params: {borrow: valid_attributes}, session: valid_session
        expect(assigns(:borrow)).to be_a(Borrow)
        expect(assigns(:borrow)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved borrow as @borrow" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the borrow as @borrow" do
        borrow = Borrow.create! valid_attributes
